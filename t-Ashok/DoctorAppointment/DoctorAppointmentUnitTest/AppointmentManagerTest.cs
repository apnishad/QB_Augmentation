...
namespace DoctorAppointmentUnitTest
{
    ...
    public class AppointmentManagerTest
    {
        ...
        [Test]
        public void MakeAppointmentTest_FirstofDay_Success() {
            ...
            mgr = new AppointmentManager(mockContext.Object);

            Appointment apm = mgr.MakeApppointment(new Appointment { APatient = new Patient { FirstName = "Kush", MiddleName = "Ram", LastName = "Verma", Gender = "Male", Mobile = "9921304656" }, ADate = DateTime.Now.AddDays(1) });           
            Assert.AreEqual("10:00", apm.ATime.ToString("HH:mm"));
            mockset1.Verify(a => a.Add(It.IsAny<Appointment>()),Times.Once);
            mockContext.Verify(c => c.SaveChanges(), Times.Once());
        }

        [Test]
        public void MakeAppointmentTest_LastofDay_Success()
        {
            ...
            Appointment apm = mgr.MakeApppointment(a12);
            Assert.AreEqual("13:40", apm.ATime.ToString("HH:mm"));
            mockset1.Verify(a => a.Add(It.IsAny<Appointment>()), Times.Once());
            mockContext.Verify(c => c.SaveChanges(), Times.Once());
        }

        [Test]
        public void MakeAppointmentTest_Should_Not_Be_MoreThan_12()
        {
            Patient p1 = new Patient { PID = 1, FirstName = "Kush", MiddleName = "Ram", LastName = "Verma", Gender = "Male", Mobile = "9921304656" };
            Patient p2 = new Patient { PID = 2, FirstName = "Ramesh", MiddleName = "Ram", LastName = "Verma", Gender = "Male", Mobile = "9921304656" };
            Patient p3 = new Patient { PID = 3, FirstName = "Somesh", MiddleName = "Ram", LastName = "Verma", Gender = "Male", Mobile = "9921304656" };
            ...
            Exception ex = Assert.Throws<Exception>(() => { mgr.MakeApppointment(a13); });

            Assert.AreEqual("No Schedule is available",ex.Message);
        }
        ...
        public void GetAppointmentTest() {
            ...
            Appointment a8 = new Appointment { AID = 8, ADate = DateTime.Now.AddDays(1), APatient = p8, ATime = new DateTime(1, 1, 2, 12, 20, 0), AStatus = AppointmentStatus.Pending };
            Appointment a9 = new Appointment { AID = 9, ADate = DateTime.Now.AddDays(1), APatient = p9, ATime = new DateTime(1, 1, 2, 12, 40, 0), AStatus = AppointmentStatus.Pending };
            Appointment a10 = new Appointment { AID = 10, ADate = DateTime.Now.AddDays(1), APatient = p10, ATime = new DateTime(1, 1, 2, 1, 0, 0), AStatus = AppointmentStatus.Pending };
            Appointment a11 = new Appointment { AID = 11, ADate = DateTime.Now.AddDays(1), APatient = p11, ATime = new DateTime(1, 1, 2, 1, 20, 0), AStatus = AppointmentStatus.Pending };
            Appointment a12 = new Appointment { ADate = DateTime.Now.AddDays(1), APatient = p12 };
            ...
            var apmt = mgr.GetAppointment(1);

            Assert.AreEqual(a1, apmt);
        }
        
        [Test]
        public void GetAppointmentTest_DoesnotExist()
        {
            Patient p1 = new Patient { PID = 1, FirstName = "Kush", MiddleName = "Ram", LastName = "Verma", Gender = "Male", Mobile = "9921304656" };
            Patient p2 = new Patient { PID = 2, FirstName = "Ramesh", MiddleName = "Ram", LastName = "Verma", Gender = "Male", Mobile = "9921304656" };
            Patient p3 = new Patient { PID = 3, FirstName = "Somesh", MiddleName = "Ram", LastName = "Verma", Gender = "Male", Mobile = "9921304656" };
            ...
            var apmt = mgr.GetAppointment(20);
